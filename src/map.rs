...
impl Map
{
    ...
    pub fn new_map_test() -> Map
    {
        ...
        for x in 0..80
        {
            let idx0 = map.xy_idx(x, 0);
            map.tiles[idx0] = TileType::Wall;
            let idx1 = map.xy_idx(x, 49);
            map.tiles[idx1] = TileType::Wall;
        }
        for y in 0..50
        {
            let idx0 = map.xy_idx(0, y);
            map.tiles[idx0] = TileType::Wall;
            let idx1 = map.xy_idx(79, y);
            map.tiles[idx1] = TileType::Wall;
        }

        let mut rng = rltk::RandomNumberGenerator::new();
        let player_pos_idx = map.xy_idx(40, 25);
        for _i in 0..400
        {
